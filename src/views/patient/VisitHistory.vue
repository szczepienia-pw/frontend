<template>
			...
			<template #content>
				...
				<Timeline :value="vaccinations" v-if="!loading">
					...
					<template #content="{ item }">
						<div class="history-item" @click="() => { selectedVaccination = item; vaccinationDetailsDialog = true; }">
    ...
    <Dialog v-model:visible="vaccinationCancelDialog" :style="{width: '450px'}" header="Confirm" modal :draggable="false">
        <div class="confirmation-content">
            ...
            <span>Are you sure you want to cancel visit <b>{{new Date(selectedVaccination.vaccinationSlot.date).toLocaleString()}}</b>?</span>
        </div>
        <template #footer>
