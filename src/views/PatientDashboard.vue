<template>
	<div
		...
		style="padding-top: 50px; padding-bottom: 50px; min-height: 85vh">
		<Button v-if="!dialogVisible" label="Edit personal data" @click="dialogVisible = !dialogVisible" />
		<Card v-if="dialogVisible" class="data-card">
